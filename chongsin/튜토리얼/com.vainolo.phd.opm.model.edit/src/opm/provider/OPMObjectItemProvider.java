...
/**
 * This is the item provider adapter for a {@link opm.OPMObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OPMObjectItemProvider extends OPMThingItemProvider {
	/**
	...
	protected void addOpdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OPMObject_opd_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OPMObject_opd_feature", "_UI_OPMObject_type"),
				 OpmPackage.Literals.OPM_OBJECT__OPD,
				 true,
				 false,
				 true,
				 null,

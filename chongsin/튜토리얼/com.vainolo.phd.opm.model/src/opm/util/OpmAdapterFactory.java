...
public class OpmAdapterFactory extends AdapterFactoryImpl {
	...
	protected OpmSwitch<Adapter> modelSwitch =
		new OpmSwitch<Adapter>() {
			@Override
			public Adapter caseObjectProcesDiagram(ObjectProcesDiagram object) {
				return createObjectProcesDiagramAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link opm.ObjectProcesDiagram <em>Object Proces Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createObjectProcesDiagramAdapter() {
		return null;
	}
